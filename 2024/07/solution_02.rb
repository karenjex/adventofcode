...
# Test input (sum of the three equations that could be true is 11387):
  ...
  for num, idx in numbers.map.with_index
    ...
    if idx==0
      ...
      for possible_result in possible_results
        ...
        new_possible_results.append((possible_result.to_s+num).to_i)    # append the result of concatenating the next number
      end
