# GOAL: Calculate the sum of all boxes' GPS coordinates after the robot finishes moving.

# Predict the motion of the robot and boxes in the warehouse. After the robot is finished moving, what is the sum of all boxes' GPS coordinates?

# Input: map of the warehouse and a list of movements the robot will attempt to make
# The movements will sometimes fail as boxes are shifted around, making the actual movements of the robot difficult to predict.

# smaller example in input_test_1.txt (sum of GPS coords = 2028)
# longer example in input_test_2.txt (sum of GPS coords = 10092)

# top of document is the map showing positions of:
#   robot: @
#   box:   O
#   wall:  #

# As the robot attempts to move, if there are any boxes in the way, the robot will attempt to push those boxes.
# If this action would cause the robot or a box to move into a wall, nothing moves, including the robot.

# bottom of document describes the moves that the robot will attempt to make, in order. 
#   ^   for up
#   v   for down
#   <   for left
#   >   for right
...
# GPS coordinate of a box: 100 * distance from top edge of map plus distance from left edge of map.
