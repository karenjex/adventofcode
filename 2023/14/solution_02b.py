...
# 2nd attempt - don't try converting between rows and columns
...
class RockGrid:
    ...
    def tilt_east(self):
        ...
        self.rock_columns=self.rows_to_cols(tilted_to_east)
...
# each rock has 3 pieces of information: 
#   row_id (between 0 and num_rows-1)
#   col_id (between 0 and num_cols-1)
#   value  ('.', 'O' or '#')
