...
# Calculate prediction of the next value in each history. 
...
for index,sequences in enumerate(history):
    new_seq=get_new_seq(index,sequences[0])
    next_val=0
    for sequence in sequences:
        next_val+=sequence[-1]
    # print(sequences)
    sum_of_next_vals+=next_val
